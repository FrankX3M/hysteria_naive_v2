...
Понадобится: Debian 11/12 или Ubuntu 22.04/24.04, root, ≥ 1 ГБ RAM и домен с A-записью на сервер. Установщик задаст несколько вопросов и сам развернёт Hysteria2 + NaiveProxy.
 
Подробности, неинтерактивный режим и восстановление после сбоя шага — в разделе [«Быстрый старт»](#быстрый-старт) ниже.
